                ...
                <div class="container">
                    <div class="page-title-content">
                        ...
                        <ul>
                            ...
                            <li class="item"><a href="login.html"><i class='bx bx-chevrons-right'></i>Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="bg-image">
                    <img src="frontend/assets/img/page-title-area/contact.jpg" alt="Demo Image">
                </div>
            </div>
            <!-- end page title area -->
